...
# taking in array of integers
# Iterate each of the elements and check to see if they're divisible by 3
# print out all of the numbers tthat are divislbe by 3

def divis_by_three(list):
    for num in list:
        if num % 3 == 0:
            print(num)

my_list = [85, 46, 27, 81, 94, 9, 27, 38, 43, 99, 37, 63, 31, 42, 14]
divis_by_three(my_list)